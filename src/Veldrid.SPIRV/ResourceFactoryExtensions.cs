...
public static class ResourceFactoryExtensions
{
    ...
    private static byte[] GetBytes(GraphicsBackend backend, string code) => backend switch
    {
    ...
    private static CrossCompileTarget GetCompilationTarget(GraphicsBackend backend) => backend switch
    {
